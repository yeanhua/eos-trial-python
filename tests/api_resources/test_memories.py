...
class TestMemories:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_add(self, client: EosTrial) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_add_with_all_params(self, client: EosTrial) -> None:
        memory = client.memories.add(
            content="content",
            user_id="user_id",
            object_keys=["string"],
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_add(self, client: EosTrial) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_add(self, client: EosTrial) -> None:
...
class TestAsyncMemories:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_add_with_all_params(self, async_client: AsyncEosTrial) -> None:
        memory = await async_client.memories.add(
            content="content",
            user_id="user_id",
            object_keys=["string"],
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_add(self, async_client: AsyncEosTrial) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_add(self, async_client: AsyncEosTrial) -> None:
