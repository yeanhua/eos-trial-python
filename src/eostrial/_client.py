...
class EosTrial(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        This automatically infers the `api_key` argument from the `EOSTRIAL_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("EOSTRIAL_API_KEY")
        ...
        custom_headers_env = os.environ.get("EOS_TRIAL_CUSTOM_HEADERS")
